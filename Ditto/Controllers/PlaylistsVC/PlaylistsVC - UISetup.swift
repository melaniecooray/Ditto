...
extension PlaylistsViewController {
    ...
    func setUpLabel() {
        ...
        recentlyPlayedLabel.center = CGPoint(x: view.frame.width/2 + 150, y: tableView.frame.minY * 0.90 )
        recentlyPlayedLabel.font = UIFont(name: "SourceSansPro-Bold", size: 20)
    ...
    func setUpTable() {
        ...
        tableView = UITableView(frame: CGRect(x: 0, y: view.frame.height/4, width: view.frame.width, height: view.frame.height - 40))
